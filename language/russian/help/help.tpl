<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip"
           href="<{$xoops_url}>/modules/soapbox/admin/index.php"
           title="Back to the administration of Soapbox"> Soapbox <img
                src="<{xoAdminIcons home.png}>"
                alt="Back to the Administration of Soapbox">
        </a></h1>

    <h4 class="odd">Description</h4><br>

    This little module has a single purpose: to help you build in your site an editorial column section, where you can manage the columns and articles published in an ordered fashion.<br><br>

    It uses Smarty templates, can take comments, it's fully searchable, includes notification options, and lets users rate the articles as well as send private messages to the authors. Also, you can decide which groups of users see what specific columns.<br><br>
    ...
    Detailed instructions on installing modules are available in the <a
        href="http://goo.gl/adT2i">XOOPS Operations Manual</a> <br><br>
