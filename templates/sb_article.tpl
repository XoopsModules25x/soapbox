                ...
                <td>
                    <ul style="margin: 0;">
                        <{foreach item=link from=$listarts.links}>
                            <li class="box"><a style="font-size: 10px;"
                                               href="<{$xoops_url}>/modules/<{$lang_moduledirname}>/article.php?articleID=<{$link.articleID}>"><{$link.arttitle}>
                                    <br><span
                                            class="smallpub"><{$link.published}></span></a></li>
                        <{/foreach}>
                    </ul>
                </td>
            </tr>
